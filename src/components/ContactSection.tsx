import { FileText, Mail, Linkedin, Github, Send } from "lucide-react";
  ...
  const contactCards = [
    {
      ...
      hoverGradient: "hover:from-blue-500/40 hover:to-sky-500/20",
    ...
    },
    {
      ...
      hoverGradient: "hover:from-purple-500/40 hover:to-fuchsia-500/20",
