            ...
            .map((card, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`text-slate-700 dark:text-white/80 transition-colors group-hover:scale-110 duration-300 ${card.hoverColor}`}
                  >
                    {card.icon}
                  </div>
                  <div className="flex-1 text-left">
                    <h3
                      className={`text-2xl font-bold text-slate-900 dark:text-white mb-1 transition-colors ${card.hoverColor}`}
                    >
                      {card.title}
                    </h3>
                    <p
                      className={`text-slate-500 dark:text-white/60 transition-colors ${card.hoverColor}`}
                    >
                  ...
                  {card.title !== "Email" && (
                    <Send
                      className={`w-5 h-5 text-slate-400 dark:text-white/40 group-hover:translate-x-1 transition-all duration-300 ${card.hoverColor}`}
                    />
                  )}
                </div>
              </a>
            ...
            >
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-slate-500 dark:text-white/60 group-hover:text-slate-700 dark:group-hover:text-white/80 transition-colors">
                    Click to reveal
                  </p>
                </div>
              </button>
