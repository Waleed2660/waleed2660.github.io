    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transition:
            "transform 450ms cubic-bezier(.4,0,.2,1), opacity 450ms cubic-bezier(.4,0,.2,1)",
      ...
      <div
        ...
        style={{
          ...
          transition:
            "transform 450ms cubic-bezier(.4,0,.2,1), background 450ms cubic-bezier(.4,0,.2,1), box-shadow 450ms cubic-bezier(.4,0,.2,1)",
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background: "radial-gradient(circle, rgba(251,191,36,0.4) 40%, transparent 70%)",
            }}
          />
        </div>
      </div>
