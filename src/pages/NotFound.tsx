  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-48 -left-48 w-[700px] h-[700px] rounded-full bg-brand/20 dark:bg-brand/12 blur-[60px] md:blur-[120px] will-change-transform" />
        <div className="absolute -top-32 -right-64 w-[600px] h-[600px] rounded-full bg-blue-700/25 dark:bg-blue-700/20 blur-[50px] md:blur-[100px] will-change-transform" />
        <div className="absolute -bottom-64 -left-32 w-[600px] h-[600px] rounded-full bg-brand/20 dark:bg-brand/10 blur-[55px] md:blur-[110px] will-change-transform" />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-12">
        <div className="max-w-xl w-full text-center">
          ...
          {/* Error Code */}
          <h1 className="text-7xl md:text-8xl font-bold text-slate-900 dark:text-white mb-6">
            404
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button
              onClick={() => navigate("/")}
              className="flex items-center gap-2 glass-strong rounded-xl px-6 py-3 text-slate-900 dark:text-white hover:text-brand hover:bg-slate-900/5 dark:hover:bg-white/10 transition-all group"
            >
