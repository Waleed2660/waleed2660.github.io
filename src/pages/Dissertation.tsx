  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className={`relative z-10 max-w-5xl mx-auto px-6 py-12 transition-all duration-700 ${
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="glass rounded-2xl p-6 border-l-4 border-blue-400/50 hover:border-blue-400 transition-all hover:scale-[1.02] duration-300">
              <div className="flex items-start gap-4 mb-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">The Problem</h3>
                  <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-4xl font-bold text-blue-700 dark:text-blue-300">£924M</span>
                    <span className="text-slate-500 dark:text-white/50 text-sm">in damages (2018-2019)</span>
                  </div>
                </div>
              </div>
            ...
            <div className="glass rounded-2xl p-6 border-l-4 border-green-400/50 hover:border-green-400 transition-all hover:scale-[1.02] duration-300">
              <div className="flex items-start gap-4 mb-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">The Solution</h3>
                  <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-4xl font-bold text-green-700 dark:text-green-300">106</span>
                    <span className="text-slate-500 dark:text-white/50 text-sm">layer neural network</span>
                  </div>
                </div>
              </div>
              <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                Implemented YOLOv3 powered by Darknet-53. The model performs detection at <span className="text-green-700 dark:text-green-300 font-semibold">three 
            ...
            <div className="glass rounded-2xl p-6 border-l-4 border-purple-400/50 hover:border-purple-400 transition-all hover:scale-[1.02] duration-300">
              <div className="flex items-start gap-4 mb-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Dataset Preparation</h3>
                  <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-4xl font-bold text-purple-700 dark:text-purple-300">9</span>
                    <span className="text-slate-500 dark:text-white/50 text-sm">countries sampled</span>
                  </div>
                </div>
              </div>
              <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                Collected high-resolution satellite imagery from Google Earth covering sites in the UK, USA, 
                Canada, South Korea, China, Pakistan, Brazil, Nigeria, and India. Used <span className="text-purple-700 dark:text-purple-300 font-semibold">LabelImg</span> for 
            ...
            <div className="glass rounded-2xl p-6 border-l-4 border-yellow-400/50 hover:border-yellow-400 transition-all hover:scale-[1.02] duration-300">
              <div className="flex items-start gap-4 mb-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Model Performance</h3>
                  <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-4xl font-bold text-yellow-700 dark:text-yellow-300">76%</span>
                    <span className="text-slate-500 dark:text-white/50 text-sm">precision achieved</span>
                  </div>
                </div>
              </div>
              <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                Achieved 76% precision on training data and 65% on validation dataset. Mean Average Precision 
                (mAP) of <span className="text-yellow-700 dark:text-yellow-300 font-semibold">0.91</span> for IoU threshold of 0.5, with <span className="text-yellow-700 dark:text-yellow-300 font-semibold">1,638 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Technical Architecture</h2>
          ...
          <div className="glass rounded-2xl overflow-hidden mb-8 hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
            <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/10 px-4 py-3 border-b border-slate-200 dark:border-white/5">
              <h3 className="text-slate-900 dark:text-white font-semibold">YOLOv3 Network Architecture</h3>
              <p className="text-slate-500 dark:text-white/50 text-xs mt-1">106-layer convolutional neural network with multi-scale detection</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="glass rounded-2xl p-6 hover:bg-slate-900/5 dark:hover:bg-white/10 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Darknet-53 Backbone</h3>
                  <div className="flex flex-wrap gap-4 mb-3">
                    <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-bold text-blue-700 dark:text-blue-300">1457</span>
                      <span className="text-slate-500 dark:text-white/50 text-xs">BFLOP/s</span>
                    </div>
                    <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-bold text-blue-700 dark:text-blue-300">78</span>
                      <span className="text-slate-500 dark:text-white/50 text-xs">FPS</span>
                    </div>
                    <div className="flex items-baseline gap-1">
                      <span className="text-2xl font-bold text-blue-700 dark:text-blue-300">53</span>
                      <span className="text-slate-500 dark:text-white/50 text-xs">Conv layers</span>
                    </div>
                  </div>
                  <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                    Neural network framework written in <span className="text-blue-700 dark:text-blue-300 font-semibold">C and CUDA</span> with 53 convolutional 
            ...
            <div className="glass rounded-2xl p-6 hover:bg-slate-900/5 dark:hover:bg-white/10 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Multi-Scale Detection</h3>
                  <div className="flex flex-wrap gap-4 mb-3">
                    <div className="flex items-center gap-2">
                      <div className="px-2 py-1 bg-green-500/10 rounded text-green-700 dark:text-green-300 text-xs font-mono">Layer 82</div>
                      <span className="text-slate-400 dark:text-white/40 text-xs">Stride 32</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="px-2 py-1 bg-green-500/10 rounded text-green-700 dark:text-green-300 text-xs font-mono">Layer 94</div>
                      <span className="text-slate-400 dark:text-white/40 text-xs">Stride 16</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="px-2 py-1 bg-green-500/10 rounded text-green-700 dark:text-green-300 text-xs font-mono">Layer 106</div>
            ...
            <div className="glass rounded-2xl p-6 hover:bg-slate-900/5 dark:hover:bg-white/10 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Transfer Learning</h3>
                  <div className="flex items-center gap-2 mb-3">
                    <div className="glass px-3 py-1 rounded-lg text-slate-900 dark:text-white">
                      <span className="text-purple-700 dark:text-purple-300 font-semibold text-sm">ImageNet</span>
                      <span className="text-slate-400 dark:text-white/40 text-xs mx-2">→</span>
                      <span className="text-purple-700 dark:text-purple-300 font-semibold text-sm">Satellite Data</span>
                    </div>
                  </div>
                  <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                    Leveraged pre-trained weights from Darknet-53 trained on ImageNet, <span className="text-purple-700 dark:text-purple-300 font-semibold">significantly 
            ...
            <div className="glass rounded-2xl p-6 hover:bg-slate-900/5 dark:hover:bg-white/10 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Non-Max Suppression & IoU</h3>
                  <div className="flex flex-wrap gap-3 mb-3">
                    <div className="glass px-3 py-1 rounded-lg border border-orange-500/20">
                      <span className="text-orange-700 dark:text-orange-300 text-xs font-semibold">IoU Threshold: 0.5</span>
                    </div>
                    <div className="glass px-3 py-1 rounded-lg border border-orange-500/20">
                      <span className="text-orange-700 dark:text-orange-300 text-xs font-semibold">NMS Applied</span>
                    </div>
                  </div>
                  <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                    Used Intersection over Union (IoU) and non-max suppression to filter overlapping bounding boxes, 
                    ensuring only the most confident predictions remain. This technique <span className="text-orange-700 dark:text-orange-300 font-semibold">reduced false 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Training Progression</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="glass rounded-2xl overflow-hidden hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
              <div className="bg-gradient-to-r from-red-500/20 to-orange-500/10 px-4 py-3 border-b border-slate-200 dark:border-white/5">
                <h3 className="text-slate-900 dark:text-white font-semibold">Early Training (200 Iterations)</h3>
                <p className="text-slate-500 dark:text-white/50 text-xs mt-1">Excessive bounding box predictions</p>
              </div>
              <div className="p-4">
                <img 
            ...
            <div className="glass rounded-2xl overflow-hidden hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
              <div className="bg-gradient-to-r from-green-500/20 to-blue-500/10 px-4 py-3 border-b border-slate-200 dark:border-white/5">
                <h3 className="text-slate-900 dark:text-white font-semibold">Refined Model (2,000 Iterations)</h3>
                <p className="text-slate-500 dark:text-white/50 text-xs mt-1">Accurate waste dump detection</p>
              </div>
              <div className="p-4">
                <img 
          ...
          <div className="space-y-4">
            ...
            <div className="glass rounded-2xl p-6 border-l-4 border-orange-400/50 hover:border-orange-400 transition-all hover:scale-[1.01] duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-3 text-lg">Training Infrastructure & Constraints</h3>
                  ...
                  <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed mb-3">
                    Models were trained over <span className="text-orange-700 dark:text-orange-300 font-semibold">several days on Google Colab</span> using NVIDIA GPUs. 
                    Larger network image sizes (608×608) improved small object detection but frequently caused <span className="text-orange-700 dark:text-orange-300 font-semibold">memory 
            ...
            <div className="glass rounded-2xl p-6 border-l-4 border-blue-400/50 hover:border-blue-400 transition-all hover:scale-[1.01] duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-3 text-lg">Dataset Diversity</h3>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <div className="px-2 py-1 bg-blue-500/10 rounded">
                      <span className="text-blue-700 dark:text-blue-300 text-xs">Developed: Well-contained</span>
                    </div>
                    <div className="px-2 py-1 bg-blue-500/10 rounded">
                      <span className="text-blue-700 dark:text-blue-300 text-xs">Developing: Visible targets</span>
                    </div>
                  </div>
                  <p className="text-slate-600 dark:text-white/70 text-sm leading-relaxed">
                    Waste dumps in developed countries (UK, USA) were well-contained and harder to detect, while 
                    developing countries (Pakistan, India, Brazil) provided more visible targets. <span className="text-blue-700 dark:text-blue-300 font-semibold">Balancing 
        ...
        <div className="text-center py-8">
          <p className="text-slate-500 dark:text-white/60 mb-6 text-lg">Want to read the full dissertation?</p>
          <a
